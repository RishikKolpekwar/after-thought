...
export default function Hero() {
    ...
    return (
        <section
            ...
            style={{ minHeight: '100vh', background: 'var(--color-bg)', paddingTop: '120px', paddingBottom: '56px' }}
        >
            {/* ═══ Earth Image ═══ */}
            <div style={{
                position: 'absolute',
            ...
            {/* Content */}
            <div style={{ position: 'relative', zIndex: 10, maxWidth: '1380px', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '24px', paddingRight: '24px' }}>
                {/* Badge */}
                ...
                >
                    <span className="block md:whitespace-nowrap">Make Disaster an Afterthought.</span>
                    <span className="block md:whitespace-nowrap" style={{ color: 'var(--color-text-secondary)' }}>Use today's data to prepare for the future.</span>
                </h1>
                <p
                    ref={r2.ref}
                ...
                >
                    <span className="block md:whitespace-nowrap">Visualize the future. Simulate outcomes.</span>
                    <span className="block md:whitespace-nowrap">Prepare for impact. Prevent failure.</span>
                </p>
